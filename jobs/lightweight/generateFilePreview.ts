...
export const generateFilePreview = async (payload: { fileId: number }) => {
  ...
  if (!file || !!file.previewKey) {
    console.log(`File ${fileId} not found or preview already exists`);
    return;
  }
  ...
  try {
    ...
    console.log(`Preview for file ${fileId} generated successfully`);
  } finally {
